...
if (path.existsSync("keys/subscription_shared_secret")) {
  sys.log("Found shared secret, requiring signatures for subscriptions.");
  var subscriptionSharedSecret  = fs.readFileSync("keys/subscription_shared_secret", "utf8");
  Config.subscriptionSharedSecret = subscriptionSharedSecret.replace(/(\n|\r)+$/, '');
}
